...
export const gOptsTextL = { color: "9F9F9F", margin: 3, border: [null, null, { pt: "1", color: "CFCFCF" }, null] };
export const gOptsOptsR = { color: "9F9F9F", margin: 3, border: [0, 0, { pt: "1", color: "CFCFCF" }, 0], align: "right" };
export const gOptsTextR = { text: "PptxGenJS", options: gOptsOptsR };
export const gOptsCode = {
	color: "9F9F9F",
	margin: 3,
...
export const gOptsSubTitle = { x: 0.5, y: 0.7, w: 4, h: 0.3, fontSize: 18, fontFace: "Arial", color: "0088CC", fill: { color: "FFFFFF" } };
export const gDemoTitleText = { fontSize: 14, color: "0088CC", bold: true };
export const gDemoTitleTextBk = { fontSize: 14, color: "0088CC", bold: true, breakLine: true };
