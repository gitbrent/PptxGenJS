...
document.getElementById('tab2slides_tabNoStyle').addEventListener('click', () => table2slidesDemoForTab('tabNoStyle', { fill: { color: 'f1f1f1' } }));
document.getElementById('tab2slides_tabInheritStyle').addEventListener('click', () => table2slidesDemoForTab('tabInheritStyle', { fill: { color: 'f1f1f1' } }));
