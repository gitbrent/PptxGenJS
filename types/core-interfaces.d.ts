...
export declare type ShapeFill = Color | {
    type: string;
    color: Color;
    alpha?: number;
};
declare type MediaType = 'audio' | 'online' | 'video';
...
export declare type TableRow = number[] | string[] | ITableCell[];
export declare type ITableRow = ITableCell[];
