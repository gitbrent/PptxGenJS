...
gulp.task('ship', gulp.series('build', 'min', 'cjs', 'es', 'bundle', 'reactTest1', 'reactTest2', 'nodeTest'), () => {
	console.log('... ./dist/*.js files created!')
})
// Build/Deploy
gulp.task('default', gulp.series('build', 'min', 'cjs', 'es', 'bundle', 'reactTest1', 'reactTest2', 'nodeTest'), () => {
	console.log('... ./dist/*.js files created!')
})
