	...
	var Slide = function () {
	    ...
	    _createClass(Slide, [{
	        ...
	        value: function header(inSlide) {
	            ...
	            // A: Background color
	            if (inSlide.slide.back) strSlideXml += (0, _helpers.genXmlColorSelection)(false, inSlide.slide.back);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function makeXmlSlide(inSlide, gObjPptx) {
	    ...
	    if (inSlide.slide.group) {
	        var startGroup,
	            endGroup,
	            group = new _slideGroup2.default(gObjPptx);
	        group.generateGroup();
	    ...
	    $.each(objSlideData, function (idx, slideObj) {
	        ...
	        switch (slideObj.type) {
	            ...
	            case 'text':
	                strSlideXml += (0, _exportText2.default)(inSlide, shapeType, slideObj, locationAttr, idx, x, y, cx, cy);
	                break;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function ExportText(inSlide, shapeType, slideObj, locationAttr, idx, x, y, cx, cy) {
	    ...
	    if (slideObj.options) {
	        slideObj.options.fill ? strSlideXml += (0, _helpers.genXmlColorSelection)(slideObj.options.fill) : strSlideXml += '<a:noFill/>';
	        ...
	        if (slideObj.options.line) {
	            ...
	            strSlideXml += (0, _helpers.genXmlColorSelection)(slideObj.options.line);
	    ...
	    if (slideObj.options.bullet && typeof slideObj.text == 'string' && slideObj.text.split('\n').length > 0 && slideObj.text.split('\n')[1] && slideObj.text.split('\n')[1].length > 0) {
	        ...
	        for (var j = 0, total_size_j = slideObj.text.length; j < total_size_j; j++) {
	            if (_typeof(slideObj.text[j]) == 'object' && slideObj.text[j].text) {
	                ...
	                strSlideXml += genXmlTextCommand(slideObj.options, slideObj.text[j] + '', inSlide.slide, outBodyOpt, outStyles, inSlide.slide.getPageNumber());
	            } else if (_typeof(slideObj.text[j]) == 'object' && slideObj.text[j].field) {
	                strSlideXml += genXmlTextCommand(slideObj.options, slideObj.text[j], inSlide.slide, outBodyOpt, outStyles, inSlide.slide.getPageNumber());
	            }
	        }
	    } else if (_typeof(slideObj.text) == 'object' && slideObj.text.field) {
	        strSlideXml += '<p:txBody>' + genXmlBodyProperties(slideObj.options) + '<a:lstStyle/><a:p>' + outStyles;
	        strSlideXml += genXmlTextCommand(slideObj.options, slideObj.text, inSlide.slide, inSlide.slide.getPageNumber());
	    }
	    ...
	    if (text_string.field) {
	        ...
	        if (parsedText.length > 1) {
	            ...
	            for (var i = 0, total_size_i = parsedText.length; i < total_size_i; i++) {
	                outTextData += outData + (0, _helpers.decodeXmlEntities)(parsedText[i]);
	...
	function genXmlTextData(text_info, slide_obj) {
	    ...
	    if ((typeof text_info === 'undefined' ? 'undefined' : _typeof(text_info)) == 'object') {
	        ...
	        if (text_info.color) {
	            out_obj.rpr_info += (0, _helpers.genXmlColorSelection)(text_info.color);
	        } else if (slide_obj && slide_obj.color) {
	            out_obj.rpr_info += (0, _helpers.genXmlColorSelection)(slide_obj.color);
	        }
	        ...
	        if (slide_obj && slide_obj.color) out_obj.rpr_info += (0, _helpers.genXmlColorSelection)(slide_obj.color);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baseGroup = __webpack_require__(26);
	...
	var SlideGroup = function (_BaseGroup) {
	    ...
	    _createClass(SlideGroup, [{
	        ...
	        value: function generateGroup() {
	            ...
	            this.groupStart = '<p:grpSp>\n                              <p:nvGrpSpPr>\n                                <p:cNvPr id="' + this.wrapperGroupCoordinate.id + '" name="' + this.wrapperGroupCoordinate.name + '"/>\n                                <p:cNvGrpSpPr/>\n                                <p:nvPr/>\n                              </p:nvGrpSpPr>\n                              <p:grpSpPr>\n                              <a:xfrm>\n                              <a:off x="' + (0, _helpers.inch2Emu)(this.wrapperGroupCoordinate.x) + '"  y="' + (0, _helpers.inch2Emu)(this.wrapperGroupCoordinate.y) + '"/>\n                              <a:ext cx="' + (0, _helpers.inch2Emu)(this.wrapperGroupCoordinate.cx) + '" cy="' + (0, _helpers.inch2Emu)(this.wrapperGroupCoordinate.cy) + '" />\n                              <a:chOff x="' + (0, _helpers.inch2Emu)(this.wrapperGroupCoordinate.x) + '"  y="' + (0, _helpers.inch2Emu)(this.wrapperGroupCoordinate.y) + '" />\n                              <a:chExt cx="' + (0, _helpers.inch2Emu)(this.wrapperGroupCoordinate.cx) + '" cy="' + (0, _helpers.inch2Emu)(this.wrapperGroupCoordinate.cy) + '" />\n                              </a:xfrm>\n                              </p:grpSpPr>';
...
/***/ function(module, exports) {
	...
	var BaseGroup = function BaseGroup(name) {
	    ...
	    this.wrapperGroupCoordinate = { id: id, name: name, x: 0, y: 0, cx: 0, cy: 0 };
	};
