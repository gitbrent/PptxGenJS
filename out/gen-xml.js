 ...
 */
import { CRLF, EMU, ONEPT, MASTER_OBJECTS, REGEX_HEX_COLOR, BARCHART_COLORS, PIECHART_COLORS, DEF_CELL_BORDER, DEF_CELL_MARGIN_PT, DEF_CHART_GRIDLINE, DEF_SHAPE_SHADOW, SCHEME_COLOR_NAMES, CHART_TYPES, LETTERS, SLDNUMFLDID, AXIS_ID_VALUE_PRIMARY, AXIS_ID_VALUE_SECONDARY, AXIS_ID_CATEGORY_PRIMARY, AXIS_ID_CATEGORY_SECONDARY, AXIS_ID_SERIES_PRIMARY, BULLET_TYPES, DEF_FONT_TITLE_SIZE, DEF_FONT_COLOR, DEF_FONT_SIZE, LAYOUT_IDX_SERIES_BASE, PLACEHOLDER_TYPES, SLIDE_OBJECT_TYPES, } from './enums';
                ...
                case SLIDE_OBJECT_TYPES.table:
                    ...
                    */
                    jQuery.each(arrTabRows, function (rIdx, row) {
                        ...
                        jQuery(_this).each(function (cIdx, cell) {
...
export function makeXmlContTypes(slides, slideLayouts, masterSlide) {
    var strXml = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + CRLF;
...
export function makeXmlApp(slides, company) {
    var strXml = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + CRLF;
    strXml +=
...
export function makeXmlCore(title, subject, author, revision) {
    var strXml = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + CRLF;
    strXml +=
...
export function makeXmlPresentationRels(slides) {
    var intRelNum = 0;
    var strXml = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + CRLF;
    strXml += '<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">';
 ...
 */
export function makeXmlSlide(objSlide) {
 ...
 * @return {string} strXml - slide OOXML
 */
export function makeXmlMaster(objSlide, slideLayouts) {
 ...
 * @return {String} complete XML string ready to be saved as a file
 */
export function makeXmlSlideLayoutRel(layoutNumber, slideLayouts) {
 ...
 * @return {String} complete XML string ready to be saved as a file
 */
export function makeXmlSlideRel(slides, slideLayouts, slideNumber) {
...
export function makeXmlNotesSlideRel(slideNumber) {
    return ('<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' +
        CRLF +
        '<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">' +
 ...
 * @return {String} complete XML string ready to be saved as a file
 */
export function makeXmlMasterRel(masterSlideObject, slideLayouts) {
...
export function makeXmlPresentation(slides, pptLayout) {
    var intCurPos = 0;
...
export function createHyperlinkRels(slides, inText, slideRels) {
    var arrTextObjects = [];
