...
| `datanoEffects`        | boolean |         | false     | hides the default shadow effect | `true` or `false` |
| `lineDataSize`         | number  | points  | `2`       | width of line (0 is no line)             | 0-256. Ex: `{ lineDataSize: 12 }` |
