...
// NOTE: "const enum" is required to be transpiled/built correctly!
// But.: it cant be used in pptxgen.ts as the private prop type (const enums are restricted), therefore, theres 2 for each (OUTPUTTYPE and OutputType)
