...
export function makeXmlTheme (pres: IPresentationProps): string {
	// "Headings" & "Body"
	console.log(pres.theme)

	const majorFont = '<a:latin typeface="Consolas"/>' // TODO: WIP: WORKS!!!
	const minorFont = '<a:latin typeface="Consolas"/>'
	// const majorFont = '<a:latin typeface="Calibri Light" panose="020F0302020204030204"/>'
	// const minorFont = '<a:latin typeface="Calibri" panose="020F0502020204030204"/>'
