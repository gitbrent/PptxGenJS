 ...
 */
export declare type Coord = number | string;
 ...
 */
export declare type DataOrPathProps = {
    /**
...
export declare type ThemeColor = 'tx1' | 'tx2' | 'bg1' | 'bg2' | 'accent1' | 'accent2' | 'accent3' | 'accent4' | 'accent5' | 'accent6';
export declare type Color = HexColor | ThemeColor;
export declare type Margin = number | [number, number, number, number];
export declare type HAlign = 'left' | 'center' | 'right' | 'justify';
...
export declare type MediaType = 'audio' | 'online' | 'video';
...
export declare type ChartAxisTickMark = 'none' | 'inside' | 'outside' | 'cross';
...
export interface IChartOpts extends IChartPropsAxisCat, IChartPropsAxisSer, IChartPropsAxisVal, IChartPropsBase, IChartPropsChartBar, IChartPropsChartDoughnut, IChartPropsChartLine, IChartPropsChartPie, IChartPropsChartRadar, IChartPropsDataLabel, IChartPropsDataTable, IChartPropsLegend, IChartPropsTitle, OptsChartGridLine, PositionProps {
}
