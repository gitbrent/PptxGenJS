...
export type CHART_NAME = 'area' | 'area3D' | 'bar' | 'bar3D' | 'bubble' | 'bubble3D' | 'doughnut' | 'line' | 'line3D' | 'ofPie' | 'pie' | 'pie3D' | 'scatter' | 'stock' | 'treemap' | 'sunburst' | 'histogram' | 'pareto' | 'boxWhisker' | 'waterfallChartEx' | 'funnel' | 'regionMap';
